...
import static com.oozeetech.bizdesk.ui.AddNewBizActivity.SELECT_CUSTOMER_CODE;
...
public class CustomerFragment extends BaseFragment {
    ...
    FilterListener filterListener = new FilterListener() {
        ...
        public void onCheckChangeListener() {
            ...
            pref.putListString("", ids);

            customerIds = TextUtils.join(",", ids);
        }
    };
        ...
        public void onResponse(Call<GetPartyResponse> call, Response<GetPartyResponse> response) {
            ...
            if (response.isSuccessful()) {
                if (response.body().getReturnCode().equals("1")) {
                    ...
                    adapter.clear();
//                    if (pref.getListString("").size() > 0) {
//                        for (GetPartyResponse.Data myList : pref.getListString("")) {
//                            adapter.add(myList);
//                        }
//                    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode != RESULT_OK)
            return;
        if (requestCode == SELECT_CUSTOMER_CODE) {
