...
public class PartyOutStandingFragment extends BaseFragment implements View.OnClickListener {
    ...
    public PartyOutStandingFragment() {
    ...
    private void initListView() {
        ...
        adapter = new PaymentOutStandingAdapter(getActivity(), callListener, "Party Payment");
